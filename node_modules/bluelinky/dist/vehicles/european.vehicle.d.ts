...
import { VehicleStatus, FullVehicleStatus, VehicleOdometer, VehicleLocation, VehicleClimateOptions, VehicleRegisterOptions, VehicleStatusOptions, RawVehicleStatus, VehicleMonthlyReport, DeepPartial, VehicleTargetSOC, VehicleDayTrip, VehicleMonthTrip } from '../interfaces/common.interfaces';
...
declare type ChargeTarget = 50 | 60 | 70 | 80 | 90 | 100;
