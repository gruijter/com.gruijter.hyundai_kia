...
declare type BluelinkyConfigRegions = AmericanBlueLinkyConfig | CanadianBlueLinkyConfig | EuropeBlueLinkyConfig | ChineseBlueLinkConfig | AustraliaBlueLinkyConfig;
export declare class BlueLinky<T extends BluelinkyConfigRegions = AmericanBlueLinkyConfig, REGION = T['region'], VEHICLE_TYPE extends Vehicle = REGION extends REGIONS.US ? AmericanVehicle : REGION extends REGIONS.CA ? CanadianVehicle : REGION extends REGIONS.CN ? ChineseVehicle : REGION extends REGIONS.AU ? AustraliaVehicle : EuropeanVehicle> extends EventEmitter {
    private controller;
    private vehicles;
    private config;
