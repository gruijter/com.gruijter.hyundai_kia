...
var EuropeanController = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, Promise.resolve('PIN entered OK, The pin is valid for 10 minutes')];
                }
            });
        });
    };
    EuropeanController.prototype.login = function () {
        return __awaiter(this, void 0, void 0, function () {
            var cookieJar, authCodeResponse, regexMatch, credentials, notificationReponse, formData, response, responseBody, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, Promise.resolve('Login success')];
                    case 7:
                        err_1 = _a.sent();
                ...
                switch (_a.label) {
                    case 0:
                        if (this.session.accessToken === undefined) {
                            return [2 /*return*/, Promise.reject('Token not set')];
                        }
...
//# sourceMappingURL=european.controller.hyundai.js.map