...
export class EuropeanController extends SessionController {
    ...
    refreshAccessToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield got(ALL_ENDPOINTS.EU.token, {
                method: 'POST',
                headers: {
    ...
    enterPin() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield got(`${EU_BASE_URL}/api/v1/user/pin`, {
                method: 'PUT',
                headers: {
    ...
    login() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield got(ALL_ENDPOINTS.EU.session, { cookieJar });
                // required by the api to set lang
                yield got(ALL_ENDPOINTS.EU.language, { method: 'POST', body: '{"lang":"en"}', cookieJar });
                const authCodeResponse = yield got(ALL_ENDPOINTS.EU.login, {
                    method: 'POST',
                    json: true,
                    body: {
                ...
                const credentials = yield pr.register(EU_CONSTANTS.GCMSenderID);
                const notificationReponse = yield got(`${EU_BASE_URL}/api/v1/spa/notifications/register`, {
                    method: 'POST',
                    headers: {
    ...
    getVehicles() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield got(`${EU_BASE_URL}/api/v1/spa/vehicles`, {
                method: 'GET',
                headers: {
                    'Authorization': this.session.accessToken,
            ...
            yield this.asyncForEach(response.body.resMsg.vehicles, (v) => __awaiter(this, void 0, void 0, function* () {
                const vehicleProfileReponse = yield got(`${EU_BASE_URL}/api/v1/spa/vehicles/${v.vehicleId}/profile`, {
                    method: 'GET',
                    headers: {
                        'Authorization': this.session.accessToken,
                        'ccsp-device-id': this.session.deviceId,
