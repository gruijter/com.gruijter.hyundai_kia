...
export default class CanadianVehicle extends Vehicle {
    ...
    lock() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.request(CA_ENDPOINTS.lock, {}, { pAuth: preAuth });
    ...
    unlock() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const preAuth = yield this.getPreAuth();
                yield this.request(CA_ENDPOINTS.unlock, {}, { pAuth: preAuth });
    ...
    */
    start(startConfig) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const preAuth = yield this.getPreAuth();
                const response = yield this.request(CA_ENDPOINTS.start, body, { pAuth: preAuth });
    ...
    stop() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const preAuth = yield this.getPreAuth();
                const response = yield this.request(CA_ENDPOINTS.stop, {
                    pAuth: preAuth,
                });
                return response;
            }
    ...
    lights(withHorn = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const preAuth = yield this.getPreAuth();
                const response = yield this.request(CA_ENDPOINTS.hornlight, { horn: withHorn }, { pAuth: preAuth });
                return response;
            }
            catch (err) {
                throw 'error: ' + err;
    ...
    location() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const preAuth = yield this.getPreAuth();
                const response = yield this.request(CA_ENDPOINTS.locate, {}, { pAuth: preAuth });
    ...
    getPreAuth() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.request(CA_ENDPOINTS.verifyPin, {});
