            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, vehicleInfoResponse];
                    case 3:
                        err_1 = _a.sent();
                        throw err_1.message;
                    ...
                    case 2:
                        ...
                        parsedStatus = {
                            ...
                            climate: {
                                ...
                                temperatureSetpoint: vehicleStatus === null || vehicleStatus === void 0 ? void 0 : vehicleStatus.airTemp.value,
                                temperatureUnit: vehicleStatus === null || vehicleStatus === void 0 ? void 0 : vehicleStatus.airTemp.unit,
                            },
                            engine: {
                                ...
                                range: (_k = vehicleStatus === null || vehicleStatus === void 0 ? void 0 : vehicleStatus.dte) === null || _k === void 0 ? void 0 : _k.value,
                                charging: (_l = vehicleStatus === null || vehicleStatus === void 0 ? void 0 : vehicleStatus.evStatus) === null || _l === void 0 ? void 0 : _l.batteryCharge,
                                batteryCharge12v: (_m = vehicleStatus === null || vehicleStatus === void 0 ? void 0 : vehicleStatus.battery) === null || _m === void 0 ? void 0 : _m.batSoc,
                                batteryChargeHV: (_o = vehicleStatus === null || vehicleStatus === void 0 ? void 0 : vehicleStatus.evStatus) === null || _o === void 0 ? void 0 : _o.batteryStatus,
                            },
                        };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, this._nextService];
                    case 3:
                        err_3 = _a.sent();
                        throw err_3.message;
                    case 4: return [2 /*return*/];
                    ...
                    case 1:
                        ...
                        if (airTemp != null) {
                            if (airTemp > 27 || airTemp < 17) {
                                return [2 /*return*/, 'air temperature should be between 17 and 27 degrees'];
                            }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, response.result.pAuth];
                    case 3:
                        err_10 = _a.sent();
                        throw 'error: ' + err_10;
                    case 4: return [2 /*return*/];
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (response.body.responseHeader.responseCode != 0) {
                            return [2 /*return*/, response.body.responseHeader.responseDesc];
                        }
